#ifndef CRTPEDESTALLUT_HH
#define CRTPEDESTALLUT_HH
...
class CRTPedestalLUT {

  public:

  CRTPedestalLUT(TString pedestalFileName, Int_t numberOfElectronicsModules, Int_t numberOfAsicRows, Int_t numberOfAsicColumns, Int_t numberOfAsicChannels, Int_t numberOfWindows, Int_t numberOfSamples, bool check = true) {
  //constructor
  ...
  Float_t GetMean(Int_t eModule, Int_t asicRow, Int_t asicCol, Int_t asicCh, Int_t window, Int_t sample) {
  ...
  Float_t GetRMS(Int_t eModule, Int_t asicRow, Int_t asicCol, Int_t asicCh, Int_t window, Int_t sample) {
    Long64_t entry(this->GetEntry(eModule, asicRow, asicCol, asicCh, window, sample));
    if (entry != -1) {
      m_pedestalTree->GetEntry(entry);
  ...
  std::pair<Float_t, Float_t> GetMeanAndRMS(Int_t eModule, Int_t asicRow, Int_t asicCol, Int_t asicCh, Int_t window, Int_t sample) {
    Long64_t entry(this->GetEntry(eModule, asicRow, asicCol, asicCh, window, sample));
    if (entry != -1) {
      m_pedestalTree->GetEntry(entry);
  ...
  Long64_t GetEntry(Int_t eModule, Int_t asicRow, Int_t asicCol, Int_t asicCh, Int_t window, Int_t sample) {
  ...
  private:
    ...
    Long64_t m_pedestalTreeEntries;
    Int_t    m_pedestalEModule;
    Int_t    m_pedestalAsicRow;
    Int_t    m_pedestalAsicCol;
    Int_t    m_pedestalAsicCh;
    Int_t    m_pedestalWindow;
    Int_t    m_pedestalSample;
    Float_t  m_pedestalMean;
    Float_t  m_pedestalRMS;

    Int_t    m_numberOfElectronicsModules;
    Int_t    m_numberOfAsicRows;
    Int_t    m_numberOfAsicColumns;
    Int_t    m_numberOfAsicChannels;
    Int_t    m_numberOfWindows;
    Int_t    m_numberOfSamples;

    bool     m_check;
    Int_t    m_maxWarnings;
    Int_t    m_numberOfWarnings;
