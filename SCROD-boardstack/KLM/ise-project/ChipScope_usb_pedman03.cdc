...
Project.filter<0>=
Project.filter<10>=daq_gen
Project.filter<11>=trg*
Project.filter<12>=miss*
Project.filter<13>=tr*
Project.filter<14>=scint*
Project.filter<15>=\\
Project.filter<16>=klm_tr*
Project.filter<17>=daq*
Project.filter<18>=usb*
Project.filter<1>=internal_readout*
Project.filter<2>=internal_*
Project.filter<3>=qt_*
Project.filter<4>=qt_
Project.filter<5>=tx_*
Project.filter<6>=tx_
Project.filter<7>=qt*
Project.filter<8>=*
Project.filter<9>=daq_gen*
...
Project.unit<3>.dataChannel<0>=klm_scrod_trig_interface qt_fifo_rd_d<15>
Project.unit<3>.dataChannel<10>=klm_scrod_trig_interface qt_fifo_rd_d<5>
Project.unit<3>.dataChannel<11>=klm_scrod_trig_interface qt_fifo_rd_d<4>
Project.unit<3>.dataChannel<12>=klm_scrod_trig_interface qt_fifo_rd_d<3>
Project.unit<3>.dataChannel<13>=klm_scrod_trig_interface qt_fifo_rd_d<2>
Project.unit<3>.dataChannel<14>=klm_scrod_trig_interface qt_fifo_rd_d<1>
Project.unit<3>.dataChannel<15>=klm_scrod_trig_interface qt_fifo_rd_d<0>
Project.unit<3>.dataChannel<16>=klm_scrod_trig_interface qt_fifo_empty
Project.unit<3>.dataChannel<17>=klm_scrod_trig_interface qt_fifo_evt_rdy
Project.unit<3>.dataChannel<18>=klm_scrod_trig_interface qt_fifo_rd_en
Project.unit<3>.dataChannel<19>=klm_scrod_trig_interface daq_dst_rdy_n
Project.unit<3>.dataChannel<1>=klm_scrod_trig_interface qt_fifo_rd_d<14>
Project.unit<3>.dataChannel<20>=klm_scrod_trig_interface daq_src_rdy_n
Project.unit<3>.dataChannel<21>=klm_scrod_trig_interface daq_sof_n
Project.unit<3>.dataChannel<22>=klm_scrod_trig_interface daq_eof_n
Project.unit<3>.dataChannel<23>=klm_scrod_trig_interface scint_trg
Project.unit<3>.dataChannel<24>=klm_scrod_trig_interface PROD_GEN.daq_gen_ins scint_trgrdy_i
Project.unit<3>.dataChannel<25>=klm_scrod_trig_interface PROD_GEN.daq_gen_ins trigger
Project.unit<3>.dataChannel<26>=klm_scrod_trig_interface PROD_GEN.daq_gen_ins trgrdy
Project.unit<3>.dataChannel<27>=klm_scrod_trig_interface PROD_GEN.daq_gen_ins trgnext
Project.unit<3>.dataChannel<28>=klm_scrod_trig_interface PROD_GEN.daq_gen_ins missed_trg_i<7>
Project.unit<3>.dataChannel<29>=klm_scrod_trig_interface PROD_GEN.daq_gen_ins missed_trg_i<6>
Project.unit<3>.dataChannel<2>=klm_scrod_trig_interface qt_fifo_rd_d<13>
Project.unit<3>.dataChannel<30>=klm_scrod_trig_interface PROD_GEN.daq_gen_ins missed_trg_i<5>
Project.unit<3>.dataChannel<31>=klm_scrod_trig_interface PROD_GEN.daq_gen_ins missed_trg_i<4>
Project.unit<3>.dataChannel<32>=klm_scrod_trig_interface PROD_GEN.daq_gen_ins missed_trg_i<3>
Project.unit<3>.dataChannel<33>=klm_scrod_trig_interface PROD_GEN.daq_gen_ins missed_trg_i<2>
Project.unit<3>.dataChannel<34>=klm_scrod_trig_interface PROD_GEN.daq_gen_ins missed_trg_i<1>
Project.unit<3>.dataChannel<35>=klm_scrod_trig_interface PROD_GEN.daq_gen_ins missed_trg_i<0>
Project.unit<3>.dataChannel<3>=klm_scrod_trig_interface qt_fifo_rd_d<12>
Project.unit<3>.dataChannel<4>=klm_scrod_trig_interface qt_fifo_rd_d<11>
Project.unit<3>.dataChannel<5>=klm_scrod_trig_interface qt_fifo_rd_d<10>
Project.unit<3>.dataChannel<6>=klm_scrod_trig_interface qt_fifo_rd_d<9>
Project.unit<3>.dataChannel<7>=klm_scrod_trig_interface qt_fifo_rd_d<8>
Project.unit<3>.dataChannel<8>=klm_scrod_trig_interface qt_fifo_rd_d<7>
Project.unit<3>.dataChannel<9>=klm_scrod_trig_interface qt_fifo_rd_d<6>
...
Project.unit<3>.triggerChannel<0><40>=
Project.unit<3>.triggerChannel<0><41>=
