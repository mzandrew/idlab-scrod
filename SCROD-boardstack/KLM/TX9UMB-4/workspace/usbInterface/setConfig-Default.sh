...
ASICno=$1
	...
	bin/target6Control_writeDacReg $ASICno 66   163 	# WR_ADDR_Inc1 LE
	bin/target6Control_writeDacReg $ASICno 67   178 	# WR_ADDR_Inc1 TE
	...
	bin/target6Control_writeDacReg $ASICno 72   163 	# WR_STRB2 LE
	bin/target6Control_writeDacReg $ASICno 73   173 	# WR_STRB2 TE
