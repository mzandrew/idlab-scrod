...
ASICno="9"
	...
	bin/target6Control_writeDacReg $ASICno 64   15	 	# SSPin LE
	bin/target6Control_writeDacReg $ASICno 65   35	 	# SSPin TE
	bin/target6Control_writeDacReg $ASICno 66   12	 	# WR_ADDR_Inc1 LE
	bin/target6Control_writeDacReg $ASICno 67   30	 	# WR_ADDR_Inc1 TE
	bin/target6Control_writeDacReg $ASICno 68   35 		# WR_STRB1 LE
	bin/target6Control_writeDacReg $ASICno 69   55 		# WR_STRB1 TE
	bin/target6Control_writeDacReg $ASICno 70   44 		# WR_ADDR_Inc2 LE
	bin/target6Control_writeDacReg $ASICno 71   62 		# WR_ADDR_Inc2 TE
	bin/target6Control_writeDacReg $ASICno 72   3	 	# WR_STRB2 LE
	bin/target6Control_writeDacReg $ASICno 73   23	 	# WR_STRB2 TE
