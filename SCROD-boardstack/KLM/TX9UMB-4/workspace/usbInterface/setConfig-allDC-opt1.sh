...
bin/target6Control_writeReg 48 16384	#main trig scaler counter max	 , count period= value*65536/63e6 seconds
bin/target6Control_writeReg 47 16384	#channels trig scaler counter max, count period= value*65536/63e6 seconds
