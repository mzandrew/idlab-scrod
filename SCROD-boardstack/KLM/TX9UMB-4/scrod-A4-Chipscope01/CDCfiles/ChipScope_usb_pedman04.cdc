...
Project.filter<0>=
Project.filter<10>=asic_reg_num
Project.filter<11>=cur*
Project.filter<12>=tx_dac_busy
Project.filter<13>=auto*
Project.filter<14>=internal_gpr_1*
Project.filter<15>=internal_gpr_1_*
Project.filter<16>=internal_gpr*
Project.filter<17>=sw2usb*
Project.filter<18>=sw2usb.
Project.filter<1>=internal_*
Project.filter<2>=readout*
Project.filter<3>=busy*
Project.filter<4>=trg*
Project.filter<5>=trig*
Project.filter<6>=internal_TRIGDEC*
Project.filter<7>=internal_TRIGDEC_trig*
Project.filter<8>=internal_TRIGDEC_trig
Project.filter<9>=asic_reg_num*
...
Project.unit<3>.dataPortWidth=40
...
Project.unit<3>.triggerPortWidth<0>=40
