...
Project.filter<0>=trg*
Project.filter<10>=auto*
Project.filter<11>=internal_gpr_1*
Project.filter<12>=internal_gpr_1_*
Project.filter<13>=internal_gpr*
Project.filter<14>=sw2usb*
Project.filter<15>=sw2usb.
Project.filter<16>=sw2usb
Project.filter<17>=internal_GPR(0)
Project.filter<18>=internal_GPR(0)(15)
Project.filter<1>=trig*
Project.filter<2>=internal_TRIGDEC*
Project.filter<3>=internal_TRIGDEC_trig*
Project.filter<4>=internal_TRIGDEC_trig
Project.filter<5>=
Project.filter<6>=asic_reg_num*
Project.filter<7>=asic_reg_num
Project.filter<8>=cur*
Project.filter<9>=tx_dac_busy
