...
./bin/target6Control_writeDacReg 0 0 2000
#Threshold Ch. 2 (PCLK_2)
./bin/target6Control_writeDacReg 0 1 2000
#Threshold Ch. 3 (PCLK_3)
./bin/target6Control_writeDacReg 0 2 2000
#Threshold Ch. 4 (PCLK_4)
./bin/target6Control_writeDacReg 0 3 2000
#Threshold Ch. 5 (PCLK_5)
./bin/target6Control_writeDacReg 0 4 2000
#Threshold Ch. 6 (PCLK_6)
./bin/target6Control_writeDacReg 0 5 2000
#Threshold Ch. 7 (PCLK_7)
./bin/target6Control_writeDacReg 0 6 2000
#Threshold Ch. 8 (PCLK_8)
./bin/target6Control_writeDacReg 0 7 2000
#Threshold Ch. 9 (PCLK_9)
./bin/target6Control_writeDacReg 0 8 2000
#Threshold Ch. 10 (PCLK_10)
./bin/target6Control_writeDacReg 0 9 2000
#Threshold Ch. 11 (PCLK_11)
./bin/target6Control_writeDacReg 0 10 2000
#Threshold Ch. 12 (PCLK_12)
./bin/target6Control_writeDacReg 0 11 2000
#Threshold Ch. 13 (PCLK_13)
./bin/target6Control_writeDacReg 0 12 2000
#Threshold Ch. 14 (PCLK_14)
./bin/target6Control_writeDacReg 0 13 2000
#Threshold Ch. 15 (PCLK_15)
./bin/target6Control_writeDacReg 0 14 2000
#Threshold Ch. 16 (PCLK_16)
./bin/target6Control_writeDacReg 0 15 2000
...
#Wbias (PCLK_22)
./bin/target6Control_writeDacReg 0 21 700
...
#ISEL (PCLK_49)
./bin/target6Control_writeDacReg 0 48 2300
#Vdischarge (PCLK_50)
./bin/target6Control_writeDacReg 0 49 800
