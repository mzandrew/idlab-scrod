...
ASICno="9"
	...
	bin/target6Control_writeDacReg $ASICno 65   31	 	# SSPin TE
	bin/target6Control_writeDacReg $ASICno 66   31	 	# WR_ADDR_Inc1 LE
	bin/target6Control_writeDacReg $ASICno 67   50	 	# WR_ADDR_Inc1 TE
	...
	bin/target6Control_writeDacReg $ASICno 72   52	 	# WR_STRB2 LE
	bin/target6Control_writeDacReg $ASICno 73   63	 	# WR_STRB2 TE
