...
Project.unit<0>.dataChannel<100>=internal_SROUT_FIFO_DATA_OUT<3>
Project.unit<0>.dataChannel<101>=internal_SROUT_FIFO_DATA_OUT<2>
Project.unit<0>.dataChannel<102>=internal_SROUT_FIFO_DATA_OUT<1>
Project.unit<0>.dataChannel<103>=internal_SROUT_FIFO_DATA_OUT<0>
Project.unit<0>.dataChannel<104>=Inst_WaveformDemuxCalcPedsBRAM win_addr_start<0>
Project.unit<0>.dataChannel<105>=Inst_WaveformDemuxCalcPedsBRAM ped_sa_update
Project.unit<0>.dataChannel<106>=Inst_WaveformDemuxCalcPedsBRAM ram_busy
Project.unit<0>.dataChannel<107>=Inst_WaveformDemuxCalcPedsBRAM ram_update
Project.unit<0>.dataChannel<108>=u_wavedemux st_tmp2bram_FSM_FFd1
Project.unit<0>.dataChannel<109>=u_wavedemux st_tmp2bram_FSM_FFd2
Project.unit<0>.dataChannel<10>=u_SamplingLgc wr_addrclr
Project.unit<0>.dataChannel<110>=u_wavedemux ped_win<1>
Project.unit<0>.dataChannel<111>=u_wavedemux ped_win<2>
Project.unit<0>.dataChannel<112>=u_wavedemux dmx_allwin_busy
Project.unit<0>.dataChannel<113>=u_ReadoutControl internal_LATCH_DONE
Project.unit<0>.dataChannel<114>=u_ReadoutControl DIG_IDLE_status
Project.unit<0>.dataChannel<115>=u_ReadoutControl SROUT_IDLE_status
Project.unit<0>.dataChannel<116>=u_ReadoutControl trigger
Project.unit<0>.dataChannel<117>=u_ReadoutControl internal_LATCH_SMP_MAIN_CNT<8>
Project.unit<0>.dataChannel<118>=u_ReadoutControl internal_LATCH_SMP_MAIN_CNT<7>
Project.unit<0>.dataChannel<119>=u_ReadoutControl internal_LATCH_SMP_MAIN_CNT<6>
Project.unit<0>.dataChannel<11>=u_wavedemux pswfifo_d<30>
Project.unit<0>.dataChannel<120>=u_ReadoutControl internal_LATCH_SMP_MAIN_CNT<5>
Project.unit<0>.dataChannel<121>=u_ReadoutControl internal_LATCH_SMP_MAIN_CNT<4>
Project.unit<0>.dataChannel<122>=u_ReadoutControl internal_LATCH_SMP_MAIN_CNT<3>
Project.unit<0>.dataChannel<123>=u_ReadoutControl internal_LATCH_SMP_MAIN_CNT<2>
Project.unit<0>.dataChannel<124>=u_ReadoutControl internal_LATCH_SMP_MAIN_CNT<1>
Project.unit<0>.dataChannel<125>=u_ReadoutControl internal_LATCH_SMP_MAIN_CNT<0>
Project.unit<0>.dataChannel<126>=u_DigitizingLgc StartDig
Project.unit<0>.dataChannel<127>=u_DigitizingLgc clr_out
Project.unit<0>.dataChannel<128>=u_DigitizingLgc rd_ena_out
Project.unit<0>.dataChannel<129>=u_DigitizingLgc startramp_out
Project.unit<0>.dataChannel<12>=u_wavedemux pswfifo_d<29>
Project.unit<0>.dataChannel<130>=uut_pedram update_req<2>
Project.unit<0>.dataChannel<131>=uut_pedram update_req<0>
Project.unit<0>.dataChannel<132>=uut_pedram busy<2>
Project.unit<0>.dataChannel<133>=uut_pedram busy<0>
Project.unit<0>.dataChannel<134>=uut_pedram ram_wait_i_2
Project.unit<0>.dataChannel<135>=uut_pedram ram_wait_i_0
Project.unit<0>.dataChannel<136>=u_wavedemux ram_update
Project.unit<0>.dataChannel<137>=u_wavedemux ram_busy
Project.unit<0>.dataChannel<138>=u_DigitizingLgc rd_ena_out
Project.unit<0>.dataChannel<139>=u_wavedemux pswfifo_en
Project.unit<0>.dataChannel<13>=u_wavedemux pswfifo_d<28>
Project.unit<0>.dataChannel<140>=u_wavedemux pswfifo_d<26>
Project.unit<0>.dataChannel<141>=u_wavedemux pswfifo_d<25>
Project.unit<0>.dataChannel<142>=u_wavedemux pswfifo_d<24>
Project.unit<0>.dataChannel<143>=u_wavedemux pswfifo_d<23>
Project.unit<0>.dataChannel<144>=u_wavedemux pswfifo_d<22>
Project.unit<0>.dataChannel<145>=u_wavedemux pswfifo_d<21>
Project.unit<0>.dataChannel<146>=u_wavedemux pswfifo_d<20>
Project.unit<0>.dataChannel<147>=u_wavedemux pswfifo_d<19>
Project.unit<0>.dataChannel<148>=u_wavedemux pswfifo_d<18>
Project.unit<0>.dataChannel<149>=u_wavedemux pswfifo_d<17>
Project.unit<0>.dataChannel<14>=u_wavedemux pswfifo_d<26>
Project.unit<0>.dataChannel<150>=u_wavedemux pswfifo_d<16>
Project.unit<0>.dataChannel<151>=u_wavedemux pswfifo_d<15>
Project.unit<0>.dataChannel<152>=u_wavedemux pswfifo_d<14>
Project.unit<0>.dataChannel<153>=u_wavedemux pswfifo_d<13>
Project.unit<0>.dataChannel<154>=u_wavedemux pswfifo_d<12>
Project.unit<0>.dataChannel<155>=u_wavedemux pswfifo_d<11>
Project.unit<0>.dataChannel<156>=u_wavedemux pswfifo_d<10>
Project.unit<0>.dataChannel<157>=u_wavedemux pswfifo_d<9>
Project.unit<0>.dataChannel<158>=u_wavedemux pswfifo_d<8>
Project.unit<0>.dataChannel<159>=u_wavedemux pswfifo_d<7>
Project.unit<0>.dataChannel<15>=u_wavedemux pswfifo_d<25>
Project.unit<0>.dataChannel<160>=u_wavedemux pswfifo_d<6>
Project.unit<0>.dataChannel<161>=u_wavedemux pswfifo_d<5>
Project.unit<0>.dataChannel<162>=u_wavedemux pswfifo_d<4>
Project.unit<0>.dataChannel<163>=u_wavedemux pswfifo_d<3>
Project.unit<0>.dataChannel<164>=u_wavedemux pswfifo_d<2>
Project.unit<0>.dataChannel<165>=u_wavedemux pswfifo_d<1>
Project.unit<0>.dataChannel<166>=u_wavedemux pswfifo_d<0>
Project.unit<0>.dataChannel<167>=u_wavedemux pswfifo_en
Project.unit<0>.dataChannel<168>=u_wavedemux wav_bram_addra<5>
Project.unit<0>.dataChannel<169>=u_wavedemux wav_bram_addra<6>
Project.unit<0>.dataChannel<16>=u_wavedemux pswfifo_d<24>
Project.unit<0>.dataChannel<170>=u_wavedemux wav_bram_addra<7>
Project.unit<0>.dataChannel<171>=u_wavedemux wav_bram_addra<8>
Project.unit<0>.dataChannel<172>=u_wavedemux wav_bram_addra<9>
Project.unit<0>.dataChannel<173>=u_wavedemux wav_bram_addra<10>
Project.unit<0>.dataChannel<174>=u_wavedemux wav_bram_addrb<0>
Project.unit<0>.dataChannel<175>=u_wavedemux wav_bram_addrb<1>
Project.unit<0>.dataChannel<176>=u_wavedemux wav_bram_addrb<2>
Project.unit<0>.dataChannel<177>=u_wavedemux wav_bram_addrb<3>
Project.unit<0>.dataChannel<178>=u_wavedemux wav_bram_addrb<4>
Project.unit<0>.dataChannel<179>=u_wavedemux wav_bram_addrb<5>
Project.unit<0>.dataChannel<17>=u_wavedemux pswfifo_d<23>
Project.unit<0>.dataChannel<180>=u_wavedemux wav_bram_addrb<6>
Project.unit<0>.dataChannel<181>=u_wavedemux wav_bram_addrb<7>
Project.unit<0>.dataChannel<182>=u_wavedemux wav_bram_addrb<8>
Project.unit<0>.dataChannel<183>=u_wavedemux wav_bram_addrb<9>
Project.unit<0>.dataChannel<184>=u_wavedemux wav_bram_addrb<10>
Project.unit<0>.dataChannel<185>=u_wavedemux ped_bram_addra<0>
Project.unit<0>.dataChannel<186>=u_wavedemux ped_bram_addra<1>
Project.unit<0>.dataChannel<187>=u_wavedemux ped_bram_addra<2>
Project.unit<0>.dataChannel<188>=u_wavedemux ped_bram_addra<3>
Project.unit<0>.dataChannel<189>=u_wavedemux ped_bram_addra<4>
Project.unit<0>.dataChannel<18>=u_wavedemux pswfifo_d<22>
Project.unit<0>.dataChannel<190>=u_wavedemux ped_bram_addra<5>
Project.unit<0>.dataChannel<191>=u_wavedemux ped_bram_addra<6>
Project.unit<0>.dataChannel<192>=u_wavedemux ped_bram_addra<7>
Project.unit<0>.dataChannel<193>=u_wavedemux ped_bram_addra<8>
Project.unit<0>.dataChannel<194>=u_wavedemux ped_bram_addra<9>
Project.unit<0>.dataChannel<195>=u_wavedemux ped_bram_addra<10>
Project.unit<0>.dataChannel<196>=u_wavedemux ped_sub_fetch_busy
Project.unit<0>.dataChannel<197>=u_wavedemux wav_dina<0>
Project.unit<0>.dataChannel<198>=u_wavedemux wav_dina<1>
Project.unit<0>.dataChannel<199>=u_wavedemux wav_dina<2>
Project.unit<0>.dataChannel<19>=u_wavedemux pswfifo_d<21>
Project.unit<0>.dataChannel<1>=u_SamplingLgc MAIN_CNT<8>
Project.unit<0>.dataChannel<200>=u_wavedemux wav_dina<3>
Project.unit<0>.dataChannel<201>=u_wavedemux wav_dina<4>
Project.unit<0>.dataChannel<202>=u_wavedemux wav_dina<5>
Project.unit<0>.dataChannel<203>=u_wavedemux wav_dina<6>
Project.unit<0>.dataChannel<204>=u_wavedemux wav_dina<7>
Project.unit<0>.dataChannel<205>=u_wavedemux wav_dina<8>
Project.unit<0>.dataChannel<206>=u_wavedemux wav_dina<9>
Project.unit<0>.dataChannel<207>=u_wavedemux wav_dina<10>
Project.unit<0>.dataChannel<208>=u_wavedemux wav_dina<11>
Project.unit<0>.dataChannel<209>=u_wavedemux wav_doutb<0>
Project.unit<0>.dataChannel<20>=u_wavedemux pswfifo_d<20>
Project.unit<0>.dataChannel<210>=u_wavedemux wav_doutb<1>
Project.unit<0>.dataChannel<211>=u_wavedemux wav_doutb<2>
Project.unit<0>.dataChannel<212>=u_wavedemux wav_doutb<3>
Project.unit<0>.dataChannel<213>=u_wavedemux wav_doutb<4>
Project.unit<0>.dataChannel<214>=u_wavedemux wav_doutb<5>
Project.unit<0>.dataChannel<215>=u_wavedemux wav_doutb<6>
Project.unit<0>.dataChannel<216>=u_wavedemux wav_doutb<7>
Project.unit<0>.dataChannel<217>=u_wavedemux wav_doutb<8>
Project.unit<0>.dataChannel<218>=u_wavedemux wav_doutb<9>
Project.unit<0>.dataChannel<219>=u_wavedemux wav_doutb<10>
Project.unit<0>.dataChannel<21>=u_wavedemux pswfifo_d<19>
Project.unit<0>.dataChannel<220>=u_wavedemux wav_doutb<11>
Project.unit<0>.dataChannel<221>=u_wavedemux ped_bram_addra<0>
Project.unit<0>.dataChannel<222>=u_wavedemux ped_bram_addra<1>
Project.unit<0>.dataChannel<223>=u_wavedemux ped_bram_addra<2>
Project.unit<0>.dataChannel<224>=u_wavedemux ped_bram_addra<3>
Project.unit<0>.dataChannel<225>=u_wavedemux ped_bram_addra<4>
Project.unit<0>.dataChannel<226>=u_wavedemux ped_bram_addra<5>
Project.unit<0>.dataChannel<227>=u_wavedemux ped_bram_addra<6>
Project.unit<0>.dataChannel<228>=u_wavedemux ped_bram_addra<7>
Project.unit<0>.dataChannel<229>=u_wavedemux ped_bram_addra<8>
Project.unit<0>.dataChannel<22>=u_wavedemux pswfifo_d<18>
Project.unit<0>.dataChannel<230>=u_wavedemux ped_bram_addra<9>
Project.unit<0>.dataChannel<231>=u_wavedemux ped_bram_addra<10>
Project.unit<0>.dataChannel<232>=u_wavedemux ped_dina<0>
Project.unit<0>.dataChannel<233>=u_wavedemux ped_dina<1>
Project.unit<0>.dataChannel<234>=u_wavedemux ped_dina<2>
Project.unit<0>.dataChannel<235>=u_wavedemux ped_dina<3>
Project.unit<0>.dataChannel<236>=u_wavedemux ped_dina<4>
Project.unit<0>.dataChannel<237>=u_wavedemux ped_dina<5>
...
Project.unit<0>.dataChannel<84>=internal_SROUT_FIFO_DATA_OUT<19>
Project.unit<0>.dataChannel<85>=internal_SROUT_FIFO_DATA_OUT<18>
Project.unit<0>.dataChannel<86>=internal_SROUT_FIFO_DATA_OUT<17>
Project.unit<0>.dataChannel<87>=internal_SROUT_FIFO_DATA_OUT<16>
Project.unit<0>.dataChannel<88>=internal_SROUT_FIFO_DATA_OUT<15>
Project.unit<0>.dataChannel<89>=internal_SROUT_FIFO_DATA_OUT<14>
Project.unit<0>.dataChannel<8>=u_SamplingLgc MAIN_CNT<1>
Project.unit<0>.dataChannel<90>=internal_SROUT_FIFO_DATA_OUT<13>
Project.unit<0>.dataChannel<91>=internal_SROUT_FIFO_DATA_OUT<12>
Project.unit<0>.dataChannel<92>=internal_SROUT_FIFO_DATA_OUT<11>
Project.unit<0>.dataChannel<93>=internal_SROUT_FIFO_DATA_OUT<10>
Project.unit<0>.dataChannel<94>=internal_SROUT_FIFO_DATA_OUT<9>
Project.unit<0>.dataChannel<95>=internal_SROUT_FIFO_DATA_OUT<8>
Project.unit<0>.dataChannel<96>=internal_SROUT_FIFO_DATA_OUT<7>
Project.unit<0>.dataChannel<97>=internal_SROUT_FIFO_DATA_OUT<6>
Project.unit<0>.dataChannel<98>=internal_SROUT_FIFO_DATA_OUT<5>
Project.unit<0>.dataChannel<99>=internal_SROUT_FIFO_DATA_OUT<4>
