...
xst -ifn xst.scr
move clockgen_asic_A_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\clockgen_asic_A.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clockgen_asic_A.ucf clockgen_asic_A_exdes

echo 'Running map'
map -timing -pr b clockgen_asic_A_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm clockgen_asic_A_exdes -w routed.ncd routed.vhd
cd ..
