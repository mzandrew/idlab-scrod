...
int main(int argc, char* argv[]){
	...
	//Initialize
	control->registerWriteReadback(board_id, 11, 0, regValReadback); //stop sampling
	...
	control->registerWriteReadback(board_id, 54, 100, regValReadback); //set digitization window offset: internal_CMDREG_READCTRL_dig_offset
	...
	control->registerWriteReadback(board_id, 57, 16, regValReadback); //set # of windows to read: internal_READCTRL_win_num_to_read
